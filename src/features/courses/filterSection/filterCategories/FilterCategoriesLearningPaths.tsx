...
import { useGetCategoriesLearningPathsQuery } from '@redux/apis/categories/categoriesApi'
import { StyledTitle } from '@features/users/userProfile/UserProfile.style'

function FilterCategoriesLearningPaths({
  filtersQueryParams,
  handleFiltersChange,
}: FilterCategoriesProps) {
  const { t } = useTranslation()
  const { queryParams } = usePagination()
  const { data: response, isLoading } = useGetCategoriesLearningPathsQuery({
    ...queryParams,
...
export default FilterCategoriesLearningPaths
