export const home = {
  ...
  service_description_3: 'Engagez-vous avec une communauté mondiale d’apprenants',
  service_description_4: 'Obtenez des certificats partageables à la fin du cours',
