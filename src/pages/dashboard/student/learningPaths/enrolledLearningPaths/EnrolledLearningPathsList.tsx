...
import { useGetEnrolledLearningPathsQuery } from '@redux/apis/learningPaths/learningPathsApi'

function EnrolledLearningPathsList() {
  const {
    queryParams,
    handlePageChange,
  ...
  const { isLoading, data } = useGetEnrolledLearningPathsQuery({
    ...queryParams,
...
export default EnrolledLearningPathsList
